...
def check_events(ai_settings, stats, sb, screen, ship, bullets, aliens, play_button):
    """
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_play_button(ai_settings, stats, sb, screen, ship, bullets,
                aliens, play_button, mouse_x, mouse_y)

def check_play_button(ai_settings, stats, sb, screen, ship, bullets,
        aliens, play_button, mouse_x, mouse_y):
    """
...
def start_game(ai_settings, stats, sb, screen, ship, bullets, aliens):
    """
    Start a new game by reseting stats and sprites.
    """
...
def update_screen(ai_settings, stats, sb, screen, ship, bullets, aliens, play_button):
    """
...
def update_bullets(ai_settings, stats, sb, screen, ship, bullets, aliens):
    ...
    check_bullet_aliens_collisions(ai_settings, stats, sb, screen, ship, bullets, aliens)
    
def check_bullet_aliens_collisions(ai_settings, stats, sb, screen, ship, bullets, aliens):
    """
    Respond to bullet alien collisions.
    """
    #Remove any collided bullets and aliens.
...
def ship_hit(ai_settings, stats, screen, ship, bullets, aliens):
    ...
    """
    #Checks for game over based on ships left.
