...
class Scoreboard():
    ...
    def __init__(self, ai_settings, stats, screen):
        ...
        #Load the life image.  
        self.life_image = pygame.image.load('images/life.bmp')
    ...
    def prep_high_score(self):
        ...
        #Display high score at top right of the screen.
    ...
    def prep_score(self):
        ...
        #Display the socre below the high score.
    ...
    def prep_level(self):
        """
        Turn the current level into the rendered image.
        """
    ...
    def draw_lives(self):
        """
        Draws approprite number of lives as per stats.
        """
        for life_num in range(self.stats.ships_left):
            life_rect = self.life_image.get_rect()
            life_rect.x = 10 + life_num * ( life_rect.width + 2)
            life_rect.y = 10
